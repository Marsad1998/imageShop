...
if (@$dbc) {
  ...
  // End data base connection\
   //  Make Page form Side Bar Daynamically..
  // $page = "pages/".((empty($_REQUEST['nav']))?'home':$_REQUEST['nav']).".php";
...
<?php 
  ...
  function getGender($sts){
    ...
    case '1':
      # code...
    return '<label class="label label-success">Male</label>';
    #code....
      break;
      default:
      break;
  ...
  function getLevel($sts){
    switch ($sts) {
      case 'l1':
        # code...
      return '<label class="label label-danger">Level 1</label>';
        break;
      case 'l2':
        # code...
      return '<label class="label label-inverse">Level 2</label>';
        break;
      case 'l3':
        # code...
      return '<label class="label label-warning">Level 3</label>';
        break;
      case 'l4':
        # code...
      return '<label class="label label-primary">Level 4</label>';
        break;
      case 'l5':
        # code...
      return '<label class="label label-success">Level 5</label>';
        break;
      default:
        # code...
        break;
